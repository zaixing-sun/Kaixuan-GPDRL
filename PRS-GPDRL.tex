...
\subsubsection{HV and IGD Results}

Table~\ref{Table: main results} presents the mean and standard deviation of
the HV and IGD values over the 30 independent runs of the compared algorithms.
...
\midrule
$\langle10,0.2\rangle$
& 0.533$\pm$0.189 & 0.597$\pm$0.131($\approx$) & 0.789$\pm$0.092($\uparrow$)($\uparrow$) & 0.867$\pm$0.068($\uparrow$)($\uparrow$)($\uparrow$)
& 0.321$\pm$0.135 & 0.235$\pm$0.081($\uparrow$) & 0.100$\pm$0.032($\uparrow$)($\uparrow$) & 0.047$\pm$0.024($\uparrow$)($\uparrow$)($\uparrow$) \\
$\langle10,0.8\rangle$
& 0.536$\pm$0.211 & 0.616$\pm$0.124($\uparrow$) & 0.788$\pm$0.113($\uparrow$)($\uparrow$) & 0.882$\pm$0.059($\uparrow$)($\uparrow$)($\uparrow$)
& 0.310$\pm$0.145 & 0.199$\pm$0.063($\uparrow$) & 0.107$\pm$0.038($\uparrow$)($\uparrow$) & 0.042$\pm$0.020($\uparrow$)($\uparrow$)($\uparrow$) \\
$\langle15,0.2\rangle$
& 0.566$\pm$0.124 & 0.602$\pm$0.107($\approx$) & 0.800$\pm$0.114($\uparrow$)($\uparrow$) & 0.862$\pm$0.087($\uparrow$)($\uparrow$)($\uparrow$)
& 0.257$\pm$0.099 & 0.166$\pm$0.054($\uparrow$) & 0.068$\pm$0.031($\uparrow$)($\uparrow$) & 0.040$\pm$0.028($\uparrow$)($\uparrow$)($\uparrow$) \\
$\langle15,0.8\rangle$
& 0.539$\pm$0.128 & 0.651$\pm$0.109($\uparrow$) & 0.749$\pm$0.150($\uparrow$)($\uparrow$) & 0.843$\pm$0.081($\uparrow$)($\uparrow$)($\uparrow$)
& 0.303$\pm$0.094 & 0.154$\pm$0.054($\uparrow$) & 0.084$\pm$0.057($\uparrow$)($\uparrow$) & 0.047$\pm$0.034($\uparrow$)($\uparrow$)($\uparrow$) \\
$\langle20,0.2\rangle$
& 0.607$\pm$0.168 & 0.632$\pm$0.122($\approx$) & 0.789$\pm$0.134($\uparrow$)($\uparrow$) & 0.869$\pm$0.088($\uparrow$)($\uparrow$)($\uparrow$)
& 0.260$\pm$0.128 & 0.173$\pm$0.077($\uparrow$) & 0.078$\pm$0.041($\uparrow$)($\uparrow$) & 0.050$\pm$0.048($\uparrow$)($\uparrow$)($\uparrow$) \\
$\langle20,0.8\rangle$
& 0.530$\pm$0.170 & 0.646$\pm$0.107($\uparrow$) & 0.776$\pm$0.110($\uparrow$)($\uparrow$) & 0.825$\pm$0.060($\uparrow$)($\uparrow$)($\uparrow$)
& 0.276$\pm$0.133 & 0.151$\pm$0.075($\uparrow$) & 0.074$\pm$0.035($\uparrow$)($\uparrow$) & 0.055$\pm$0.038($\uparrow$)($\uparrow$)($\approx$) \\
$\langle30,0.2\rangle$
& 0.635$\pm$0.139 & 0.675$\pm$0.091($\uparrow$) & 0.823$\pm$0.101($\uparrow$)($\uparrow$) & 0.867$\pm$0.060($\uparrow$)($\uparrow$)($\uparrow$)
& 0.247$\pm$0.110 & 0.152$\pm$0.050($\uparrow$) & 0.083$\pm$0.037($\uparrow$)($\uparrow$) & 0.053$\pm$0.046($\uparrow$)($\uparrow$)($\uparrow$) \\
$\langle30,0.8\rangle$
& 0.568$\pm$0.132 & 0.697$\pm$0.091($\uparrow$) & 0.788$\pm$0.091($\uparrow$)($\uparrow$) & 0.803$\pm$0.090($\uparrow$)($\uparrow$)($\approx$)
& 0.291$\pm$0.108 & 0.127$\pm$0.039($\uparrow$) & 0.080$\pm$0.030($\uparrow$)($\uparrow$) & 0.074$\pm$0.043($\uparrow$)($\uparrow$)($\approx$) \\
$\langle50,0.2\rangle$
& 0.611$\pm$0.152 & 0.702$\pm$0.098($\uparrow$) & 0.808$\pm$0.103($\uparrow$)($\uparrow$) & 0.851$\pm$0.114($\uparrow$)($\uparrow$)($\uparrow$)
& 0.232$\pm$0.095 & 0.112$\pm$0.040($\uparrow$) & 0.082$\pm$0.042($\uparrow$)($\uparrow$) & 0.059$\pm$0.043($\uparrow$)($\uparrow$)($\uparrow$) \\
$\langle50,0.8\rangle$
& 0.644$\pm$0.164 & 0.749$\pm$0.103($\uparrow$) & 0.783$\pm$0.135($\uparrow$)($\uparrow$) & 0.815$\pm$0.110($\uparrow$)($\uparrow$)($\uparrow$)
& 0.240$\pm$0.105 & 0.099$\pm$0.032($\uparrow$) & 0.074$\pm$0.039($\uparrow$)($\uparrow$) & 0.075$\pm$0.041($\uparrow$)($\uparrow$)($\approx$) \\
...
& 0.269$\pm$0.139 & 0.146$\pm$0.063($\uparrow$) & 0.075$\pm$0.034($\uparrow$)($\uparrow$) & 0.079$\pm$0.040($\uparrow$)($\uparrow$)($\approx$) \\
$\langle100,0.8\rangle$
& 0.798$\pm$0.081 & 0.866$\pm$0.059($\uparrow$) & 0.852$\pm$0.067($\uparrow$)($\downarrow$) & 0.810$\pm$0.086($\approx$)($\downarrow$)($\downarrow$)
& 0.190$\pm$0.078 & 0.079$\pm$0.055($\uparrow$) & 0.066$\pm$0.024($\uparrow$)($\approx$) & 0.135$\pm$0.056($\uparrow$)($\downarrow$)($\downarrow$) \\
\midrule
W/D/L & 0/1/11 & 1/0/11 & 1/1/10 & N/A
      & 0/0/12 & 1/0/11 & 1/4/7 & N/A \\
AverageRank & 3.603 & 3.017 & 1.975 & 1.406
            & 3.792 & 2.847 & 1.883 & 1.478 \\
\bottomrule
\end{tabular}}
\end{table*}
...
\midrule
$\langle10,0.2\rangle$
& 0.832$\pm$0.098 & 0.851$\pm$0.076($\approx$) & 0.860$\pm$0.071($\uparrow$)($\uparrow$) & 0.867$\pm$0.068($\uparrow$)($\uparrow$)($\approx$)
& 0.078$\pm$0.046 & 0.058$\pm$0.030($\uparrow$) & 0.052$\pm$0.033($\uparrow$)($\approx$) & 0.047$\pm$0.024($\uparrow$)($\uparrow$)($\approx$) \\
$\langle10,0.8\rangle$
& 0.827$\pm$0.093 & 0.855$\pm$0.068($\uparrow$) & 0.880$\pm$0.064($\uparrow$)($\uparrow$) & 0.882$\pm$0.059($\uparrow$)($\uparrow$)($\approx$)
& 0.076$\pm$0.047 & 0.058$\pm$0.032($\uparrow$) & 0.039$\pm$0.017($\uparrow$)($\uparrow$) & 0.042$\pm$0.020($\uparrow$)($\uparrow$)($\approx$) \\
$\langle30,0.2\rangle$
& 0.814$\pm$0.103 & 0.848$\pm$0.074($\uparrow$) & 0.851$\pm$0.076($\approx$)($\approx$) & 0.867$\pm$0.060($\uparrow$)($\uparrow$)($\uparrow$)
& 0.090$\pm$0.058 & 0.068$\pm$0.047($\uparrow$) & 0.068$\pm$0.057($\uparrow$)($\approx$) & 0.053$\pm$0.046($\uparrow$)($\uparrow$)($\uparrow$) \\
$\langle30,0.8\rangle$
& 0.752$\pm$0.105 & 0.814$\pm$0.087($\uparrow$) & 0.809$\pm$0.081($\uparrow$)($\approx$) & 0.803$\pm$0.090($\uparrow$)($\approx$)($\approx$)
& 0.114$\pm$0.059 & 0.065$\pm$0.032($\uparrow$) & 0.074$\pm$0.034($\uparrow$)($\approx$) & 0.074$\pm$0.043($\uparrow$)($\approx$)($\approx$) \\
$\langle100,0.2\rangle$
& 0.778$\pm$0.117 & 0.828$\pm$0.075($\uparrow$) & 0.854$\pm$0.055($\uparrow$)($\uparrow$) & 0.847$\pm$0.077($\uparrow$)($\approx$)($\approx$)
& 0.118$\pm$0.071 & 0.084$\pm$0.047($\uparrow$) & 0.082$\pm$0.042($\uparrow$)($\approx$) & 0.079$\pm$0.040($\uparrow$)($\approx$)($\approx$) \\
$\langle100,0.8\rangle$
& 0.748$\pm$0.108 & 0.801$\pm$0.090($\uparrow$) & 0.816$\pm$0.081($\uparrow$)($\approx$) & 0.810$\pm$0.086($\uparrow$)($\approx$)($\approx$)
& 0.176$\pm$0.065 & 0.125$\pm$0.052($\uparrow$) & 0.121$\pm$0.051($\uparrow$)($\approx$) & 0.135$\pm$0.056($\uparrow$)($\approx$)($\approx$) \\
\midrule
...
fixed. Following Tables~\ref{Table: main results} and~\ref{Table: combined ablation results}, W/D/L reports the baseline GP
...
\midrule
$\langle10,0.2\rangle$ & 0.789$\pm$0.092 & 0.790$\pm$0.092($\approx$) & 0.100$\pm$0.032 & 0.100$\pm$0.033($\approx$) \\
$\langle10,0.8\rangle$ & 0.788$\pm$0.113 & 0.787$\pm$0.117($\approx$) & 0.107$\pm$0.038 & 0.108$\pm$0.042($\approx$) \\
$\langle15,0.2\rangle$ & 0.800$\pm$0.114 & 0.799$\pm$0.109($\approx$) & 0.068$\pm$0.031 & 0.070$\pm$0.028($\approx$) \\
$\langle15,0.8\rangle$ & 0.749$\pm$0.150 & 0.750$\pm$0.151($\approx$) & 0.084$\pm$0.057 & 0.085$\pm$0.059($\approx$) \\
$\langle20,0.2\rangle$ & 0.789$\pm$0.134 & 0.787$\pm$0.136($\approx$) & 0.078$\pm$0.041 & 0.078$\pm$0.040($\approx$) \\
$\langle20,0.8\rangle$ & 0.776$\pm$0.110 & 0.779$\pm$0.108($\approx$) & 0.074$\pm$0.035 & 0.072$\pm$0.033($\approx$) \\
$\langle30,0.2\rangle$ & 0.823$\pm$0.101 & 0.823$\pm$0.100($\approx$) & 0.083$\pm$0.037 & 0.081$\pm$0.037($\approx$) \\
$\langle30,0.8\rangle$ & 0.788$\pm$0.091 & 0.784$\pm$0.099($\approx$) & 0.080$\pm$0.030 & 0.081$\pm$0.030($\approx$) \\
$\langle50,0.2\rangle$ & 0.808$\pm$0.103 & 0.806$\pm$0.104($\approx$) & 0.082$\pm$0.042 & 0.084$\pm$0.042($\downarrow$) \\
$\langle50,0.8\rangle$ & 0.783$\pm$0.135 & 0.779$\pm$0.136($\downarrow$) & 0.074$\pm$0.039 & 0.075$\pm$0.037($\approx$) \\
$\langle100,0.2\rangle$ & 0.817$\pm$0.096 & 0.813$\pm$0.096($\approx$) & 0.075$\pm$0.034 & 0.078$\pm$0.035($\approx$) \\
$\langle100,0.8\rangle$ & 0.852$\pm$0.067 & 0.850$\pm$0.070($\approx$) & 0.066$\pm$0.024 & 0.067$\pm$0.026($\approx$) \\
\midrule
